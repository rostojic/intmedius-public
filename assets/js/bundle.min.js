...
!function(e){skel.breakpoints({wide:"(max-width: 1680px)",normal:"(max-width: 1280px)",narrow:"(max-width: 980px)",narrower:"(max-width: 840px)",mobile:"(max-width: 736px)"}),e(function(){e(window);var r=e("body");e("form").placeholder(),skel.on("+narrower -narrower",function(){e.prioritize(".important\\28 narrower\\29",skel.breakpoint("narrower").active)}),e("#nav > ul").dropotron({baseZIndex:1e4,offsetY:-16,offsetX:-1,mode:"fade",noOpenerFade:!0}),e('<div id="titleBar"><span class="title">'+e("#logo").html()+"</span></div>").appendTo(r)})}(jQuery);